...
const FormularioAlumno = ({ agregarAlumno, alumnos }) => {
  ...
  const validarFormulario = () => {
    ...
    if (alumnos) {
      const luExistente = alumnos.find(a => a.lu === formData.lu.trim().toUpperCase());
      if (luExistente) {
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input
                ...
                maxLength="8"
              />
              {errores.lu && <span className="error-message">{errores.lu}</span>}
            </div>
