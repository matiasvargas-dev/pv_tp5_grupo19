...
export const AppRouter = ({ alumnos, eliminarAlumno, agregarAlumno, editarAlumno }) => {
  return (
    <BrowserRouter>
      <NavBar />
      <Routes>
        ...
        {/* Lista Alumnos */}
        <Route path="/lista-alumnos" element={<ListaAlumnos alumnos={alumnos} eliminarAlumno={eliminarAlumno} editarAlumno={editarAlumno} />} />
